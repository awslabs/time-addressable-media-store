...
class TestWebhooks:
    ...
    def test_get_webhooks_filter_expressions(self, webhooks_table, resources):
        ...
        expression_string, expression_attribute_names, expression_attribute_values = (
            parse_dynamo_expression(kw_args["FilterExpression"])
        )
        ...
        attribute_not_exists_count = expression_string.count("attribute_not_exists")
    ...
    def test_get_matching_webhooks_pagination(self, webhooks_table):
        ...
        first_response = {
            "Items": [
                {
                    "event": "flows/created",
                    "flow_ids": ["7622bd94-f80d-49fc-a1b0-66a38c929f3e"],
        ...
        webhooks_table.query.side_effect = [first_response, second_response]
    ...
    def test_handler_posts_for_each_webhook(self, post_event, webhook_count):
        ...
        for i in range(webhook_count):
            return_items.append(
                Webhook(url=f"https://example.com/webhook{i}", events=[])
            )
