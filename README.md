...
- **OAuthScopeHead**: A comma-delimited list of OAuth scopes for this API method. Leave as default unless using custom auth settings.
- **OAuthScopeGet**: A comma-delimited list of OAuth scopes for this API method. Leave as default unless using custom auth settings.
- **OAuthScopePut**: A comma-delimited list of OAuth scopes for this API method. Leave as default unless using custom auth settings.
- **OAuthScopePost**: A comma-delimited list of OAuth scopes for this API method. Leave as default unless using custom auth settings.
- **OAuthScopeDelete**: A comma-delimited list of OAuth scopes for this API method. Leave as default unless using custom auth settings.
- **OAuthScopeAny**: A comma-delimited list of OAuth scopes for this API method. Leave as default unless using custom auth settings.
